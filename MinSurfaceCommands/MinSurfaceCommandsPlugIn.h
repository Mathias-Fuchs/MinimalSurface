// MinSurfaceCommandsPlugIn.h : main header file for the MinSurfaceCommands plug-in.
//

#pragma once

// CMinSurfaceCommandsPlugIn
// See MinSurfaceCommandsPlugIn.cpp for the implementation of this class
//
...
public:
  ...
  // CMinSurfaceCommandsPlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, CMinSurfaceCommandsPlugIn::OnUnloadPlugin() is called. Do
